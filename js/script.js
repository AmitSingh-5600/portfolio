...
$(document).ready(function() {
  ...
  $("#contact").submit(function(event) {
      ...
      $.ajax({
          type: "POST",
          url: "send_email.php", // The URL to your server-side script that handles the email sending
          data: formData,
          success: function(response) {
              // Handle the response from the server after a successful email send (if needed)
